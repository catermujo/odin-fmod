...
when ODIN_OS == .Windows {
    ...
    when LOGGING_ENABLED {
        foreign import lib "wasm/fmodL_wasm.a"
        foreign import lib "wasm/fmodL_bindings.a"
        foreign import lib "wasm/fmodL_js.a"
    } else {
        foreign import lib "wasm/fmod_wasm.a"
        foreign import lib "wasm/fmod_bindings.a"
        foreign import lib "wasm/fmod_js.a"
    }
}
